            ...
            <div class="card-header bg-white border-0 py-3 px-4 d-flex align-items-center justify-content-between flex-wrap">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <small class="text-muted">Define los filtros y genera tu documento Excel</small>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body bg-light p-5">
                <form method="post" action="" id="frmReportes">
                    ...
                    <div class="text-center mt-5">
                        <button type="submit" class="btn btn-success btn-lg px-5 py-3 shadow-lg rounded-5" id="btnGenerarExcel" style="font-weight:600; letter-spacing:0.5px;">
